...
names_report_bitrix <- c("ID","Nome", "Fase","Fechado","Data de inicio","Pessoa reponsavel ID","Pessoa responsável","Criado em","Modificado em",
                        "Modificado por ID","Modificado por","CPF","Produto Crefaz","Valor do emprestimo","Desafio","Fase automacao","Fase anterior ao desafio","Lead Fonte","Origem do Cliente","Contato Primeiro nome","Contato sobrenome","Contato Fonte","Data prevista de fechamento","Data Negociar","Data Analisar","Data prospectar","Comentario")
colnames(df)  <- names_report_bitrix
...
<div class='child inline-block-child' style="width: 600px;font-size:`r font_size`px;"> 
...
```{r,echo=FALSE,fig.height=4,include=TRUE}
...
#mapview::mapshot(x = p,file = "gauge.png",)

htmlwidgets::saveWidget(widget = p,file = "gauge.html", selfcontained=TRUE, knitrOptions=list(".html-widget.gauge {
...
webshot::webshot(url = "gauge.html",file  = "gauge.svg",vwidth = 800,vheight = 600)



```

<img src='gauge.png' width="400" height="500" />
