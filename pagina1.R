div(
    tabsetPanel(
     ...
     # type = "hidden",
      tabPanel(title = p("Envios Msg Bitrix",style="color:#E4781C;text-align:center;font-weight:bold;font-size:14px"),
                   ...
                   fluidRow(column(width = 9,
                                   ...
                                   fluidRow(column(width=4, plotlyOutput(outputId = "plot_envio_diario",height = 480)),
                                            column(width=4, plotlyOutput(outputId = "plot_envio_acumulado",height = 480))),
                                   fluidRow(column(width=4, plotlyOutput(outputId = "plot_envio_acumulado_mes",height = 480)),
                                            column(width=4 ))
                                   ),
                            column(width = 3,
     ...
     tabPanel(title = p("Indicadores Bitrix",style="color:#E4781C;text-align:center;font-weight:bold;font-size:14px"), 
               ...
               dateInput(inputId = "data_referencia",label = "Data Referência",value = max(df1$`Data de inicio`)),
                   fluidRow(column(width = 3,
